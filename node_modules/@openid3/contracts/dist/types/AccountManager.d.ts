...
export interface AccountManagerInterface extends Interface {
    getFunction(nameOrSignature: "getValidationData" | "grant" | "initAccount" | "revoke" | "setMetadata" | "supportsInterface" | "validateSignature"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "initAccount", values: [AddressLike, IAccountManager.ValidationDataStruct, BytesLike]): string;
    ...
    decodeFunctionResult(functionFragment: "initAccount", data: BytesLike): Result;
...
export interface AccountManager extends BaseContract {
    ...
    getFunction(nameOrSignature: "initAccount"): TypedContractMethod<[
        validator: AddressLike,
        data: IAccountManager.ValidationDataStruct,
        metadata: BytesLike
    ], [
    ...
    getFunction(nameOrSignature: "revoke"): TypedContractMethod<[validator: AddressLike], [void], "nonpayable">;
