...
export interface IRsaCertRegistrationInterface extends Interface {
    getFunction(nameOrSignature: "getCert"): FunctionFragment;
...
export interface IRsaCertRegistration extends BaseContract {
    connect(runner?: ContractRunner | null): IRsaCertRegistration;
    waitForDeployment(): Promise<this>;
    interface: IRsaCertRegistrationInterface;
