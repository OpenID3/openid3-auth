...
export interface RsaCertRegistrationInterface extends Interface {
    getFunction(nameOrSignature: "getCert" | "owner" | "register" | "renounceOwnership" | "revoke" | "transferOwnership"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "CertAdded" | "CertRevoked" | "OwnershipTransferred"): EventFragment;
...
export interface RsaCertRegistration extends BaseContract {
    connect(runner?: ContractRunner | null): RsaCertRegistration;
    waitForDeployment(): Promise<this>;
    interface: RsaCertRegistrationInterface;
