...
export interface GoogleZkAdminInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getLinkedAccountHash",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
    functionFragment: "linkAccount",
    values: [BytesLike]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "validateSignatureViaCache",
    values: [BytesLike, BytesLike]
  ): string;
...
export namespace AccountLinkedEvent {
  export type InputTuple = [account: AddressLike, idHash: BytesLike];
  export type OutputTuple = [account: string, idHash: string];
...
export namespace CertAddedEvent {
  export type InputTuple = [kidHash: BytesLike, cert: AddressLike];
  export type OutputTuple = [kidHash: string, cert: string];
  export interface OutputObject {
    kidHash: string;
    cert: string;
  }
...
export namespace CertRevokedEvent {
  export type InputTuple = [kidHash: BytesLike];
  export type OutputTuple = [kidHash: string];
  export interface OutputObject {
    kidHash: string;
  }
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export interface GoogleZkAdmin extends BaseContract {
  ...
  register: TypedContractMethod<
    [kidHash: BytesLike, provider: BytesLike, N: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  validateSignature: TypedContractMethod<
    [challenge: BytesLike, validationData: BytesLike],
    [bigint],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "JWT_TTL"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "MASK"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "cacheProof"
  ): TypedContractMethod<
    [
      accounts: AddressLike[],
      challenges: BytesLike[],
  ...
  >;
  getFunction(
    nameOrSignature: "getCert"
  ): TypedContractMethod<[kidHash: BytesLike], [string], "view">;
  getFunction(
    nameOrSignature: "getLinkedAccountHash"
  ): TypedContractMethod<[account: AddressLike], [string], "view">;
  getFunction(
    nameOrSignature: "linkAccount"
  ): TypedContractMethod<[idHash: BytesLike], [void], "nonpayable">;
  getFunction(
  ...
  ): TypedContractMethod<[kidHash: BytesLike], [void], "nonpayable">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "validateSignatureViaCache"
  ): TypedContractMethod<
    [challenge: BytesLike, validationData: BytesLike],
    [bigint],
    "view"
  ...
  getEvent(
    ...
    AccountLinkedEvent.InputTuple,
    AccountLinkedEvent.OutputTuple,
    AccountLinkedEvent.OutputObject
  >;
  getEvent(
    key: "CertAdded"
  ): TypedContractEvent<
    CertAddedEvent.InputTuple,
    CertAddedEvent.OutputTuple,
    CertAddedEvent.OutputObject
  >;
  getEvent(
    key: "CertRevoked"
  ): TypedContractEvent<
  ...
  filters: {
    "AccountLinked(address,bytes32)": TypedContractEvent<
      AccountLinkedEvent.InputTuple,
      AccountLinkedEvent.OutputTuple,
      AccountLinkedEvent.OutputObject
    >;
    AccountLinked: TypedContractEvent<
      AccountLinkedEvent.InputTuple,
      AccountLinkedEvent.OutputTuple,
      AccountLinkedEvent.OutputObject
    >;

    "CertAdded(bytes32,address)": TypedContractEvent<
      CertAddedEvent.InputTuple,
      CertAddedEvent.OutputTuple,
      CertAddedEvent.OutputObject
    >;
    CertAdded: TypedContractEvent<
      CertAddedEvent.InputTuple,
      CertAddedEvent.OutputTuple,
      CertAddedEvent.OutputObject
    >;

    "CertRevoked(bytes32)": TypedContractEvent<
      CertRevokedEvent.InputTuple,
      CertRevokedEvent.OutputTuple,
      CertRevokedEvent.OutputObject
    >;
