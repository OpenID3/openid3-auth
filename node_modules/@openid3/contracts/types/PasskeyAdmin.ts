...
export type PasskeyStruct = { pubKeyX: BigNumberish; pubKeyY: BigNumberish };
...
export interface PasskeyAdminInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getPasskeyId",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
    functionFragment: "setPasskey",
    values: [PasskeyStruct, string]
  ): string;
  encodeFunctionData(
...
export namespace PasskeySetEvent {
...
export interface PasskeyAdmin extends BaseContract {
  ...
  setPasskey: TypedContractMethod<
    [pubKey: PasskeyStruct, passkeyId: string],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "getPasskeyId"
  ): TypedContractMethod<[account: AddressLike], [string], "view">;
  getFunction(
    nameOrSignature: "setPasskey"
  ): TypedContractMethod<
    [pubKey: PasskeyStruct, passkeyId: string],
    [void],
    "nonpayable"
  ...
  getEvent(
    ...
    PasskeySetEvent.InputTuple,
    PasskeySetEvent.OutputTuple,
    PasskeySetEvent.OutputObject
  >;

  filters: {
    "PasskeySet(address,bytes32,tuple,string)": TypedContractEvent<
      PasskeySetEvent.InputTuple,
      PasskeySetEvent.OutputTuple,
      PasskeySetEvent.OutputObject
    >;
    PasskeySet: TypedContractEvent<
      PasskeySetEvent.InputTuple,
      PasskeySetEvent.OutputTuple,
      PasskeySetEvent.OutputObject
    >;
