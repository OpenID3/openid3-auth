...
export interface OpenId3TeeModuleInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "GOOGLE_PROVIDER",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "SCHEMA_ID", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "run",
    values: [AttestationPayloadStruct, BytesLike, AddressLike, BigNumberish]
  ): string;
...
export namespace AttestedEvent {
  export type InputTuple = [accAndTypeHash: BytesLike, subject: BytesLike];
  export type OutputTuple = [accAndTypeHash: string, subject: string];
...
export interface OpenId3TeeModule extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "GOOGLE_PROVIDER"
  ...
  filters: {
    "Attested(bytes32,bytes)": TypedContractEvent<
      AttestedEvent.InputTuple,
      AttestedEvent.OutputTuple,
      AttestedEvent.OutputObject
    >;
