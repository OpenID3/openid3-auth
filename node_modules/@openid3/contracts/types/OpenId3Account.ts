...
export interface OpenId3Account extends BaseContract {
  ...
  initialize: TypedContractMethod<
    [adminData: BytesLike, operatorData: BytesLike, metadata: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  setAdmin: TypedContractMethod<
    [admin: AddressLike, adminData: BytesLike],
    [void],
    "nonpayable"
  >;

  setOperator: TypedContractMethod<
    [operator: AddressLike, operatorData: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "accountManager"
